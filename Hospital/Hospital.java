...
public class Hospital {
    ...
    public void treats(Patient p) 
    {
        ...
        else if ( p instanceof AnimalPatient == true )
        {
             ...
             */
            AnimalPatient animal = (AnimalPatient) p;          //cast p, given a new reference(animal) is AnimalPatient Type
            animal.call_vet();                               //use this new reference to call the method in AnimalPatient Class
        }
        else
        {
